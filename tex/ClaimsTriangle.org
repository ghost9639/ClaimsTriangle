#+TITLE: Life Insurance Reserves Calculator
#+AUTHOR: R
...
The dataset used is taken from ChainLadder itself. ABC is a neatly formatted claims triangle for the worker's compensation portfolio of a large company. The data comes from 11 accident years and includes 11 development years, collected by [cite:@ABCsourcing]. 

#+CAPTION: ABC Data
#+ATTR_LATEX: :center t :environment tabularx :width \linewidth
...
#+DOWNLOADED: screenshot @ 2025-11-14 16:12:31
#+CAPTION: Claims developments over time
[[file:Dataset/2025-11-14_16-12-31_screenshot.png]]
...
#+NAME: a2a calc
#+CAPTION: Age-to-age factor calculator
...
#+DOWNLOADED: screenshot @ 2025-11-14 20:30:54
#+CAPTION: Estimated Age to Age effects
[[file:Dataset/2025-11-14_20-30-54_screenshot.png]]
...
#+DOWNLOADED: screenshot @ 2025-11-14 20:28:34
#+CAPTION: Projected Claims
[[file:Dataset/2025-11-14_20-28-34_screenshot.png]]
...
1) There exist a vector of constants like the ones we found earlier,
2) Future shifts in claims developments happen independently of past ones (claims are i.i.d.),
3) The variance of claims in a period are directly related to claims in the past period.
...
#+DOWNLOADED: screenshot @ 2025-11-14 21:08:55
#+CAPTION: LDFs for the Mack Model
[[file:Mack_Model/2025-11-14_21-08-55_screenshot.png]]
...
#+DOWNLOADED: screenshot @ 2025-11-14 21:25:58
#+CAPTION: Mack Model Summary
[[file:Mack_Model/2025-11-14_21-25-58_screenshot.png]]
...
#+DOWNLOADED: screenshot @ 2025-11-14 21:29:00
#+CAPTION: Mack Model Summary (Only latest 5 years used in Estimation)
[[file:Mack_Model/2025-11-14_21-29-00_screenshot.png]]
